 ...
 */
export declare class IpfsHfsImpl implements HfsImpl {
    #private;
    /**
 ...
 */
export declare class IpfsHfs extends Hfs implements HfsImpl {
    /** Creates a new instance. */
    constructor({ root }: {
        root: UnixFS;
    });
}
export declare const mount: () => Promise<IpfsHfs>;
