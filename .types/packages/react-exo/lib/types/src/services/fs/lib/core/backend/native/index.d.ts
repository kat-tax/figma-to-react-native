 ...
 */
export declare class NativeHfsImpl implements HfsImpl {
    #private;
    /**
 ...
 */
export declare class NativeHfs extends Hfs implements HfsImpl {
    /** Creates a new instance. */
    constructor({ root }: {
        root: typeof FileSystem;
    });
}
export declare const mount: () => Promise<NativeHfs>;
