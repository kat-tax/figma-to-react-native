...
export declare const RawTextbox: import("preact").FunctionalComponent<Omit<import("../../../../utilities/create-component.js").MixinHTMLElementAttributes<HTMLInputElement, RawTextboxProps>, "ref"> & {
