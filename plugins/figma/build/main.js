...
var require_blake2s = __commonJS({
  "../../node_modules/.pnpm/blakejs@1.2.1/node_modules/blakejs/blake2s.js"(exports, module) {
    ...
    function blake2sHex3(input, key, outlen) {
      const output = blake2s(input, key, outlen);
      return util.toHex(output);
    }
    module.exports = {
      blake2s,
      blake2sHex: blake2sHex3,
      blake2sInit,
      blake2sUpdate,
      blake2sFinal
    };
...
function writeChildren(writer, flags, data, settings, children, getStylePrefix, pressables) {
  ...
  const state2 = { writer, flags, data, locales, settings, pressables, getStylePrefix };
      ...
      case "Text":
        ...
        if (propValue.startsWith("props.")) {
          ...
          if ((_a2 = settings == null ? void 0 : settings.react) == null ? void 0 : _a2.addTranslate) {
            ...
            if (state2.locales) {
              const { id, defaultModeId } = state2.locales;
              const hash = (0, import_blakejs2.blake2sHex)(propValue);
...
var init_writeChildren = __esm({
  "src/backend/generator/lib/writeChildren.ts"() {
    import_blakejs2 = __toESM(require_blakejs());
    init_string();
    init_lib2();
  }
});
