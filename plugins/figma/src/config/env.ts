...
export const F2RN_NAVIGATE = 'f2rn:navigate:v4';
export const F2RN_SETTINGS_USER = 'f2rn:settings:v4';
export const F2RN_SETTINGS_PROJECT = 'f2rn:settings:v4';
export const F2RN_PROJECT_RELEASE = 'f2rn:release:v4';
