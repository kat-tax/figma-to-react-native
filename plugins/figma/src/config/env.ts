...
export const F2RN_NAVIGATE = 'f2rn:navigate:v5';
export const F2RN_SETTINGS_USER = 'f2rn:user:v5';
export const F2RN_SETTINGS_PROJECT = 'f2rn:project:v5';
export const F2RN_PROJECT_RELEASE = 'f2rn:release:v5';
