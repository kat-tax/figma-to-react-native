...
export function Toolbar() {
  return (
    <List aria-label="header" className="tab-bar">
      <Trigger value="code" className="tab-trigger">
        Code
      </Trigger>
      <Trigger value="theme" className="tab-trigger">
        Theme
      </Trigger>
      <Trigger value="output" className="tab-trigger">
        Output
      </Trigger>
      <Trigger value="preview" className="tab-trigger">
        Preview
      </Trigger>
      <div className="expand"/>
      {/*<span id="copy" className="action" title="Copy code to clipboard">
        <svg width="34" height="34" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" fill="black" d="M10 16C10 14.8954 10.8954 14 12 14H14V13H12C10.3431 13 9 14.3431 9 16C9 17.6569 10.3431 19 12 19H14V18H12C10.8954 18 10 17.1046 10 16ZM18 14V13H20C21.6569 13 23 14.3431 23 16C23 17.6569 21.6569 19 20 19H18V18H20C21.1046 18 22 17.1046 22 16C22 14.8954 21.1046 14 20 14H18ZM13 16.5H19V15.5H13V16.5Z"/>
        </svg>
      </span>*/}
      <Trigger value="settings" className="tab-trigger">
